...
Usage:
    python src/visualization/plot_mpc_saved_results.py <result_dir>

Example:
    python src/visualization/plot_mpc_saved_results.py validation_results/mpc_validation/20251115_141102_mpc_ch_2d_alpha1.0
"""
