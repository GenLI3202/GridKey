...
This file provides guidance to CLAUDE Code Assistant when working with code in this repository. To understand the ultimate purpose and structure of the project, please refer to `doc\whole_project_description.md`.
